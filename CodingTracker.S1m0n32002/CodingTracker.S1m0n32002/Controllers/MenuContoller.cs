    ...
    internal static class MenuContoller
    {
        ...
        static void ShowReport()
        {
            ...
            if (Sessions.Any())
            {
                ...
                AnsiConsole.MarkupLine($"You're coding sessions have an avarage duration of [green]{Math.Truncate(avarageDuration.TotalHours):00}:{avarageDuration.Minutes:00}:{avarageDuration.Seconds:00}[/].");
            }
            else
            {
